...
//        Address address = ((AddressAdapter) getListAdapter()).getItem(position);
//
...
//        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            titleTextView.setText(address.getLastName() + ", " + address.getFirstName());
            TextView dateTextView =
                    (TextView) convertView.findViewById(R.id.address_list_item_companyTextView);
            dateTextView.setText(address.getCompany());
