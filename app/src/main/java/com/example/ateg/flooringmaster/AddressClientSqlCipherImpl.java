...
public class AddressClientSqlCipherImpl extends SQLiteOpenHelper implements AddressDao, AddressClient {
    ...
    public AddressClientSqlCipherImpl(@ApplicationContext Context context,
                                      String passPhrase,
    ...
    private List<Address> search(String stringToSearchFor, String sqlQueryToUse, ResultSegment<AddressSortByEnum> addressResultSegment) {
        SQLiteDatabase sqLiteDatabase = this.getReadableDatabase(passPhrase);
    ...
    public Address delete(Integer id) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase(passPhrase);
    ...
    @Override
    public int size() {
        return (int) this.getReadableDatabase(passPhrase).compileStatement(SQL_GET_ADDRESS_COUNT).simpleQueryForLong();
    }
